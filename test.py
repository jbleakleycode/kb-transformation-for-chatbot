...
def getOntologyStrings():
    ...
    # Convert the lists to strings and concatenate them with newlines
    ontology_string = (
        "Team: " + ", ".join(team_ontologies) + " END\n" +
        "Content Distribution: " + ", ".join(content_distribution_ontologies) + " END\n" +
        "Industry: " + ", ".join(industry_ontologies) + " END\n" +
        "Use-Case: " + ", ".join(use_case_ontologies) + " END\n" +
        "Content Maturity: " + ", ".join(content_maturity_ontologies) + " END\n" +
        "Content Type: " + ", ".join(content_type_ontologies) + " END\n" +
        "Editions: " + ", ".join(editions_ontologies) + " END"
    )
    
    return ontology_string

if __name__ == "__main__":
    ontology_string = getOntologyStrings()
